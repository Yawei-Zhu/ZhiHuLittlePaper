...
import io.github.zhihulittlepaper.util.CommenUtils;
import io.github.zhihulittlepaper.view.INewsListView;
import io.github.zhihulittlepaper.view.PullListView;
import io.github.zhihulittlepaper.view.PullListView.OnPullListScrollListener;
...
public class NewsListActivity extends Activity implements INewsListView  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvTitle = (TextView) findViewById(R.id.tv_news_list_title);
	...
	private void setListeners() {
		...
		lvNews.setOnPullListScrollListener(new OnPullListScrollListener() {
			@Override
			public void onPullListScroll(AbsListView view, int firstVisibleItem) {
				if(adapter != null && adapter.getCount() > firstVisibleItem) {
						tvTitle.setText(CommenUtils.parseDate(adapter.getItem(firstVisibleItem).getDate()));
				}
			}
		});
