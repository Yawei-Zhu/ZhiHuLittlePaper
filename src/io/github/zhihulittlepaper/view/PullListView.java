...
public class PullListView extends ListView implements AbsListView.OnScrollListener {
	...
	private final static int STATE_LOADING = 5;
	...
	private OnPullListScrollListener onPullListScrollListener;
	...
	private void init(Context context) {
		...
		isLoadable = false;
		currentLoadState = STATE_NO_DONE;
	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		if(onPullListScrollListener != null) {
			onPullListScrollListener.onPullListScroll(view, firstVisibleItem);
		}
	...
	public void setOnPullListScrollListener(OnPullListScrollListener l) {
		this.onPullListScrollListener = l;
	}
	...
	public interface OnPullListScrollListener {
		void onPullListScroll(AbsListView view, int firstVisibleItem);
	}
